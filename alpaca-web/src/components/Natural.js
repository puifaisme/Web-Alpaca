...
const Natural = () => {
    ...
    return (
        ...
        <div className="container">
             <div className="row">
                <div className="col-6 col-md-6 d-flex align-items-center align-items-md-start"> <img src={kd} className="border-image"/></div>
            ...
            <div className="row">
                <div className="col-6 col-md-6 d-flex align-items-center align-items-md-start"> <img src={pk} className="border-image"/></div>
                <div className="col-6 col-md-6">
            ...
            <div className="row">
                <div className="col-6 col-md-6 d-flex align-items-center align-items-md-start margin-v"> <img src={bp} className="border-image"/></div>
                <div className="col-6 col-md-6">
